...
-
系统封装了DictSelect组件，[/flash-vue/src/components/DictSelect/index.vue](https://gitee.com/enilu/web-flash/blob/master/flash-vue-admin/src/components/DictSelect/index.vue)
方便对字典数据的使用

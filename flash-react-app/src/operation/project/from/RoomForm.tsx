...
import CodeHighlighter from "../../Knowledge/components/CodeHighlighter";
import MarkdownEditor from "../../Knowledge/components/MarkdownEditor";



import FileUploadWithAction from "../../../components/File/components/action/FileUploadWithAction"
import SysAttMainListView from "../../../components/File/SysAttMainListView";
        ...
        >
            ...
            {activeTab === 'markdown' ? (
                ...
                <Form.Item
                    ...
                    label="附件"
                >
                    <FileUploadWithAction fileKey="测试数据"/>
            ...
            <Form.Item
                ...
                label="附件"
            >
                <SysAttMainListView  fdId="dddddddddddd"/>

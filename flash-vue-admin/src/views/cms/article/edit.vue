  ...
  <div class="app-container">
    <div class="block">
      <el-form ref="form" :model="form">
        ...
        <el-row :gutter="20">
          <el-col :span="24">
            <el-button icon="el-icon-plus" size="mini" type="primary" @click="save">{{ $t('button.submit') }}
            </el-button>
          ...
          <el-col :span="12">
            <el-row :gutter="20">
              <el-col :span="24">
                <el-input v-model="form.title" minlength=1 placeholder="档案标题"
                          style="font-size: 1.2rem;margin:.2rem 0rem;"></el-input>
              </el-col>
            </el-row>
            <el-row :gutter="20">
              <el-col :span="8">

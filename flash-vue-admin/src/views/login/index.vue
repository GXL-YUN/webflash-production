  ...
  <div class="login-container"  v-if="isVisible" style="background-image: url(./img/bg.jpg)">
    ...
    >
      ...
      <el-tabs v-model="qrcode.activeName" type="border-card" @tab-click="changeLoginType">
        <el-tab-pane label="Account password login" name="first">
...
<!--          <div v-if="qrcode.activeName=='second'">
          ...
          <div style="position: relative;text-align:center;">
            ...
            <div v-if="qrcode.resultStatus=='success'">
              ...
              <el-button class="btn  btn-link btn-xs qrCodeRefresh" href="#"
                         style="font-size:12px ;font-weight: bolder;color:rgb(0,146,248)">重新扫描
              </el-button>
            </div>
          </div>-->

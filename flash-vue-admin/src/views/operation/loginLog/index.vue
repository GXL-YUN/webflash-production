<template>
  <div class="app-container">
    <div class="block">
      <el-row :gutter="24">
        <el-col :span="4">
          <el-date-picker type="date" size="mini" placeholder="起始日期" v-model="listQuery.beginTime"
                          value-format="yyyy-MM-dd"
                          style="width: 100%;"></el-date-picker>
        </el-col>
        <el-col :span="4">
          <el-date-picker type="date" size="mini" placeholder="结束日期" v-model="listQuery.endTime"
                          value-format="yyyy-MM-dd"
                          style="width: 100%;"></el-date-picker>
        </el-col>
        ...
        <el-col :span="8">
          ...
          <el-button type="danger" size="mini" icon="el-icon-delete" @click.native="clear"
                     v-permission="['/loginLog/delLoginLog']">{{ $t('button.clear') }}
          </el-button>
        </el-col>
      </el-row>
      <br>

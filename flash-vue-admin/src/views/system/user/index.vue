    ...
    <div class="block">
      ...
      <el-row>
        <el-col :span="24">
          ...
          <el-button type="danger" size="mini" icon="el-icon-refresh-right" @click.native="resetPwd"
        ...
        <el-table :data="list" v-loading="listLoading" element-loading-text="Loading" border fit highlight-current-row
          ...
          <el-table-column label="操作" min-width="150px">
            <template slot-scope="scope">
              ...
              <el-button type="text" size="mini" icon="el-icon-s-operation" @click.native="openRoleItem(scope.row)"
                         v-permission="['/mgr/setRole']">角色分配
              </el-button>
            </template>
          </el-table-column>

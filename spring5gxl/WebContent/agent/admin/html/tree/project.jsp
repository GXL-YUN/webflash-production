...
<body>
    ...
    <div >
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="index.jsp">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">项目管理</span></div>
        </div>
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a  onclick="dialog('添加数据', 400, 500, '弹出层', '${ip}/${project}/agent/admin/html/from/taskfrom.jsp');"><i class="icon-font"></i>新增</a>
                ...
                <div class="result-content">
                    <table class="result-tab contentdate" width="100%">
                        <tr>
                            ...
                            <th style="white-space: nowrap;">svn路径</th>
                             <th style="white-space: nowrap;">创建时间</th>
                            <th style="white-space: nowrap;">接口状态</th>
                             <th style="white-space: nowrap;">项目信息</th>
   ...
   <script type="text/javascript">
	 ...
	 var count=getajax('${project}/tackcount');
	   ...
	   //查询数据
        ...
        var json=getajax('${project}/selectTack');
	   

        var json=getajax('${project}/selectTack?index='+index+'&count='+count);

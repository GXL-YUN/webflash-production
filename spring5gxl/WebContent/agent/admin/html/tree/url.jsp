...
<link rel="stylesheet" type="text/css"
	href="${ip}/${project}/css/admincommon.css" />
<link rel="stylesheet" type="text/css"
	href="${ip}/${project}/css/admin/main.css" />
<script type="text/javascript"
	src="${ip}/${project}/js/admin/modernizr.min.js"></script>
<script type="text/javascript" src=" ${ip}/${project}/js/ui/dialog.js"></script>
<script type="text/javascript"
	src="${ip}/${project}/js/jquery-1.8.0.min.js"></script>
...
<body>
		...
		<div class="crumb-wrap">
			<div class="crumb-list">
				<i class="icon-font"></i><a href="index.jsp">首页</a><span
					class="crumb-step">&gt;</span><span class="crumb-name">网址管理</span>
			</div>
		</div>
			...
			<form name="myform" id="myform" method="post">
				<div class="result-title">
					<div class="result-list">
						<a
							onclick="dialog('添加数据', 800, 500, '弹出层', '${ip}/${project}/agent/admin/html/from/contentFrom.jsp');"><i
				...
				<div class="result-content">
					<table class="result-tab contentdate" width="100%">
						<tr>
							...
							<th style="white-space: nowrap;">收藏网址名称</th>
							<th style="white-space: nowrap;">网址路径</th>
	...
	<script type="text/javascript">
		var count = getajax('${project}/url/count');
		...
		function get(index, count) {
			...
			var json = getajax('${project}/url/select?index=' + index
					+ '&count=' + count);
				...
				$(".contentdate")
						.append(
								"<tr class='list "+json[i].fd_id+"'>"
										...
										+ "</td>"
										+ "<td>"
										+ formatDate(json[i].create_time)
										+ "</td>"
										+ "<td>"
										+ changestart(json[i].fd_start)
										+ "</td>"
										+ "<td>"
										+ json[i].fd_massage
										+ "</td>"
										...
										+ "<a class='link-del' onclick=delecttr('url/deletee','"
										+ json[i].fd_id
										+ "')>删除</a>"
										+ "</td>"
										+ "</tr>");

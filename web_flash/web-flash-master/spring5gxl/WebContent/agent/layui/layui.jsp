...
<head>
  ...
  <title>layui 调试预览-BeJSON.com</title>
 <link rel="stylesheet"
	href="${ip}/${project}/css/layui/layui.css">
  <style>
    body{margin: 10px;}
...
<script src="${ip}/${project}/js/layui/layui.js"></script>
...
layui.use(function(){ //亦可加载特定模块：layui.use(['layer', 'laydate', function(){
  ...
  table.render({
    elem: '#demo'
    ,height: 420
    ,url: 'www.bejson.com/doc/layui/demo/table/user.json' //数据接口
    ,title: '用户表'
    ,page: true //开启分页
